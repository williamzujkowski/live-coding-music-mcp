...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      'dimension=energy applies an energy level (integer 0-10: 0 minimal, 5 normal, 10 maximum). ' +
      'dimension=refine applies an incremental directional refinement: faster/slower/louder/quieter/brighter/darker/"more reverb"/drier. ' +
    ...
    inputSchema: {
      ...
      properties: {
        dimension: {
          type: 'string',
          enum: ['mood', 'energy', 'refine'],
          description: 'Which dimension to shape along',
        },
        target_mood: {
          type: 'string',
  ...
  {
    name: 'set_energy',
    description: '[DEPRECATED — use shape({ dimension: "energy" }) instead] Adjust energy level 0-10. Auto-plays after applying energy level.',
    inputSchema: {
      type: 'object',

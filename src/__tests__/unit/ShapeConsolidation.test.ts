...
describe('shape consolidation (#154)', () => {
  describe('shape(dimension=mood)', () => {
    it('applies a known mood profile', async () => {
    ...
    it('reports unknown mood gracefully', async () => {
      const { ctx } = makeCtx();
  ...
  describe('shape(dimension=energy)', () => {
    it('applies energy level', async () => {
      const { ctx, pattern } = makeCtx();
  ...
  describe('shape(dimension=refine)', () => {
    it('applies a known direction', async () => {
      const { ctx, pattern } = makeCtx();

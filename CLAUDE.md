...
- **Coverage Target**: 80% overall, 100% for services. Current: 86.73% overall; PatternGenerator sits at 78.4% and StrudelEngine at 0% (its tests run against a mock because @strudel/core is ESM and Jest is not configured for it)
